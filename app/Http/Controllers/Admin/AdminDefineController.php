...
class AdminDefineController extends BaseAdminController
{
    private $error = array();
    ...
    public function _outDataView($data)
    {
        ...
        $optionDefineType = getOption($this->arrDefineType, isset($data['define_type']) ? $data['define_type'] : THU_NO_DEFINE_TYPE);
    ...
    public function view()
    {
        ...
        $search['define_type'] = addslashes(Request::get('define_type', TIEU_CHI_THAM_DINH_DEFINE_TYPE));
        ...
        return view('admin.AdminDefine.view', array_merge([
            'data' => $data['data'],
            'search' => $search,
            'total' => $data['total'],
            'stt' => ($pageNo - 1) * $limit,
    ...
    public function postItem($id)
    {
        ...
        $result['url'] = URL::route('admin.viewDefine', ['define_type' => $data['define_type']]);
    ...
    public function ajaxLoadForm()
    {
        ...
        $this->_getDataDefault();
        $this->_outDataView($data);
        return view('admin.AdminDefine.component.ajax_load_item',
            array_merge([
                'data' => $data,
            ], $this->viewPermission, $this->viewOptionData));
    }
