...
class Exam extends BaseModel
{
    ...
    protected $fillable = array('exam_name', 'data_question', 'list_question_id', 'dir_file','school_year','school_block_id','school_block_name', 'subjects_id', 'subjects_name','thematic_id', 'thematic_name', 'time_to_do', 'total_question',
