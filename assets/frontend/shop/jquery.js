	...
	$.fn.nstUI = function(user_setting)
	{
		...
		return $(this).each(function()
		{
			...
			switch (m_settings.method)
			{
				...
				case 'formAction':
				{
					...
					else
					{
						...
						_t.find('input[type=submit], button[type=submit]').click(formActionHandle);
			...
			function formActionResultHandle(data)
			{
				...
				{
                                        // Hien thi cac truong theo yeu cau
                                        if(data.show_params !== undefined)
                                        {
                                                // Hien thi thong bao loi hien tai
                                                $.each(data.show_params, function(param, value)
                                                {
                                                        if(value == true) {
                                                            _t.find('#param_' + param ).show();
                                                        }
                                                        else {
                                                            _t.find('#param_' + param ).hide();
                                                        }
                                                });
                                        }
