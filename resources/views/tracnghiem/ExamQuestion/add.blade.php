...
<div class="main-content-inner">
    <div class="breadcrumbs breadcrumbs-fixed top_nav" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="{{URL::route('tracnghiem.questionView')}}"> {{$pageAdminTitle}}</a></li>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div style="float: left; width: 50%">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="name" class="control-label">{{viewLanguage('Ảnh banner')}}</label>
                            <input type="file" name="image" id="image">
                        </div>
                        @if(isset($data['url']) && $data['image'] != '')
                            <img src="{{asset(env('APP_PATH_UPLOAD_MIDDLE').$data['image'])}}" alt="" width="90px">
                        @endif
                    </div>
