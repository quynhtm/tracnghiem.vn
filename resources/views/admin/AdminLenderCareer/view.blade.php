                    ...
                    <form method="get" action="" role="form">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control input-sm" name="career_name" placeholder="{{viewLanguage('Tên')}}" @if(isset($search['career_name']))value="{{$search['career_name']}}"@endif>
                            </div>
                            <div class="form-group col-lg-3">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                @if($is_root || $permission_full || $permission_create)
                                    <a class="btn btn-danger btn-sm" href="{{URL::route('admin.lenderCareerView')}}">
                            ...
                            @if(isset($data) && sizeof($data))
                                ...
                                <tr>
                                    ...
                                    <td class="text-center middle" align="center">
                                        @if($is_root || $permission_full || $permission_create)
                                            <a class="editItem" onclick="VM.editItem('{{$item->id}}', WEB_ROOT + '/manager/lender_career/ajaxLoad')" title="{{viewLanguage('Sửa')}}">
                    ...
                    <div class="panel-body">
                        <form id="formAdd" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="career_name" title="{{viewLanguage('Tên')}}" class="form-control input-required" id="career_name" type="text" required>
                            </div>
                            <div class="form-group">
                                <label for="name">{{viewLanguage('Mô tả')}} <span class="red"> (*) </span></label>
                                <textarea name="career_description" id="career_description" title="{{viewLanguage('Mô tả')}}" cols="30" rows="2" class="form-control input-required"></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            @if($is_root || $permission_full || $permission_create)
                            <a class="btn btn-success" id="submit" onclick="VM.addItem('form#formAdd', 'form#formAdd :input', '#submit', WEB_ROOT + '/manager/lender_career/post/0')">
