                ...
                <div class="panel panel-info">
                    <form method="Post" action="" role="form">
                        ...
                        <span style="display: none">
                            <a class="btn btn-danger btn-sm" href="{{URL::route('admin.employeeEdit',array('id' => FunctionLib::inputId(0)))}}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            @foreach ($data as $key => $item)
                                <tr @if($item['user_status'] == \App\Library\AdminFunction\Define::STATUS_BLOCK)class="detailView red bg-danger middle" @else class="middle detailView" @endif
                                data-action="{{URL::route('admin.employeeEdit',array('id' => FunctionLib::inputId($item['user_id'])))}}" >
                                    ...
                                    <td class="text-center middle" align="center">
                                        @if($is_root || $permission_full_employee)
                                            <a href="{{URL::route('admin.employeeEdit',array('id' => FunctionLib::inputId($item['user_id'])))}}" title="Sửa item"><i class="fa fa-edit fa-2x"></i></a>&nbsp;&nbsp;&nbsp;
                                        @endif
                                        @if(($is_boss) && $item['user_status'] != \App\Library\AdminFunction\Define::STATUS_BLOCK)
