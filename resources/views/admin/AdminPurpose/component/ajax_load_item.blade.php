    ...
    <div class="panel-body">
        <form id="formAdd" method="post">
            ...
            <div class="form-group">
                <label for="purpose">{{viewLanguage('Tên')}}<span class="red"> (*) </span></label>
                <input name="purpose" title="{{viewLanguage('Tên tình trạng')}}" class="form-control input-required" id="name" type="text" @if(isset($data->purpose))value="{{$data->purpose}}"@endif>
            </div>
            <div class="form-group">
            ...
            <a class="btn btn-success" id="submit" onclick="VM.addItem('form#formAdd', 'form#formAdd :input', '#submit', WEB_ROOT + '/manager/purpose/post/' + '{{$data->id}}')">
