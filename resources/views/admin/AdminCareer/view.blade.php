                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                @if($is_root || $permission_full || $permission_create)
                                    <a class="btn btn-danger btn-sm" href="{{URL::route('admin.careerView')}}">
                            ...
                            @if(isset($data) && sizeof($data))
                                ...
                                <tr>
                                    ...
                                    <td class="text-center middle" align="center">
                                        @if($is_root || $permission_full || $permission_create)
                                            <a class="editItem" onclick="VM.editItem('{{$item->id}}', WEB_ROOT + '/manager/career/ajaxLoad')" title="{{viewLanguage('Sửa')}}">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form id="formAdd" method="post">
                            ...
                            @if($is_root || $permission_full || $permission_create)
                            <a class="btn btn-success" id="submit" onclick="VM.addItem('form#formAdd', 'form#formAdd :input', '#submit', WEB_ROOT + '/manager/career/post/0')">
