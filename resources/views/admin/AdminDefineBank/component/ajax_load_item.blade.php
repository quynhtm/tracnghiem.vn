    ...
    <div class="panel-body">
        <form id="formAdd" method="post">
            ...
            <div class="form-group col-lg-6">
                <label for="define_status">{{viewLanguage('Bank Id')}}</label>
                <input name="object_id"  id="object_id" title="{{viewLanguage('Bank Id')}}" class="form-control input-required"  type="text" @if(isset($data['object_id']))value="{{$data['object_id']}}"@endif>
            </div>
            <div class="form-group col-lg-6">
            ...
            <div class="form-group col-lg-12">
                <a class="btn btn-success" id="submit" onclick="VM.addItem('form#formAdd', 'form#formAdd :input', '#submit', WEB_ROOT + '/manager/defineBank/post/' + '{{$data["id"]}}')">
