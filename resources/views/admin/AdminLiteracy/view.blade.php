                    ...
                    <form method="get" action="" role="form">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control input-sm" name="name" placeholder="{{viewLanguage('Tên')}}" @if(isset($search['name']))value="{{$search['name']}}"@endif>
                            </div>
                            <div class="form-group col-lg-3">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                @if($is_root || $permission_full || $permission_create)
                                    <a class="btn btn-danger btn-sm" href="{{URL::route('admin.literacyView')}}">
                            ...
                            @if(isset($data) && sizeof($data))
                                ...
                                <tr>
                                    ...
                                    <td class="text-center middle @if(isset(CGlobal::$array_color_status[STATUS_NEW] )) {{CGlobal::$array_color_status[STATUS_NEW]['background']}}@endif">
                                        <a href="javascript:void(0);" title="Mới" class="@if(isset(CGlobal::$array_color_status[STATUS_NEW] )) {{CGlobal::$array_color_status[STATUS_NEW]['text']}}@endif" ><span>Mới</span></a>
                                    </td>
                                    @else
                                    ...
                                    <td class="text-center middle" align="center">
                                        @if($is_root || $permission_full || $permission_create)
                                            <a class="editItem" onclick="VM.editItem('{{$item->id}}', WEB_ROOT + '/manager/literacy/ajaxLoad')" title="{{viewLanguage('Sửa')}}">
                    ...
                    <div class="panel-body">
                        <form id="formAdd" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" title="{{viewLanguage('Tên')}}" class="form-control input-required" id="name" type="text">
                            </div>
                            <div class="form-group">
                            ...
                            @if($is_root || $permission_full || $permission_create)
                            <a class="btn btn-success" id="submit" onclick="VM.addItem('form#formAdd', 'form#formAdd :input', '#submit', WEB_ROOT + '/manager/literacy/post/0')">
